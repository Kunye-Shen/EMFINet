...
class EMFINet(nn.Module):
    def __init__(self):
        ...
        self.encoder1 = self.vgg.conv2 #128
        #stage 2
        self.encoder2 = self.vgg.conv3 #256
        #stage 3
        self.encoder3 = self.vgg.conv4_1 #512
        #stage 4
        self.encoder4 = self.vgg.conv5_1 #512
        ...
        #-------------Edge--------------#
        self.up_conv = nn.Conv2d(512,256,3,dilation=8, padding=8)
        self.up_bn = nn.BatchNorm2d(256)

        self.edge_conv = nn.Conv2d(256,256,3,padding=1)
        self.edge_bn = nn.BatchNorm2d(256)
        ...
        self.mconv5 = nn.Conv2d(1024 + 256,1024,3,padding=1)
        ...
        self.mconv4 = nn.Conv2d(512 + 256,512,3,padding=1)
        ...
        self.mconv3 = nn.Conv2d(512 + 256,256,3,padding=1)
        ...
        #stage 2
        self.mconv2 = nn.Conv2d(256 + 256,128,3,padding=1)
        ...
        self.mconv1 = nn.Conv2d(128 + 256,64,3,padding=1)
        ...
        #-------------Edge output--------------#
        self.edge_outconv1 = nn.Conv2d(256,1,1,padding=0)
